...
void test_json_1() {
    ...
    H_TEST_ASSERT(jo0.error() == wcpp::json::JSONParser::kNoError);
    H_TEST_ASSERT(jo1.error() == wcpp::json::JSONParser::kNoError);
}
...
void test_json_2() {
    ...
    wcpp::json::JSONObject jo0;
    H_TEST_ASSERT(jo0.Parse(json_test_str));
    wcpp::json::JSONString* type = jo0.GetJSONString("type");
    (void)type;
    std::string serialize = jo0.ToString();
    //(void)serialize;
...
void test_json_3(const char* json_test_str) {
    ...
    H_TEST_ASSERT(jo0.error() == wcpp::json::JSONParser::kNoError);
    H_TEST_ASSERT(jo1.error() == wcpp::json::JSONParser::kNoError);
    H_TEST_ASSERT(jo2.error() == wcpp::json::JSONParser::kNoError);
}
...
void testJSONParser() {
    ...
    wcpp::json::ObjectPtr jo = wcpp::json::JSONParser::Load(s);
    H_TEST_ASSERT(jo);
    std::string ss = jo->ToString(1);
    //std::cout << std::endl << ss << std::endl;

    s = "[12, 11.1, {\"type\":\"11\",\"img\":\"http:\\/\\/p6.qhimg.com\\/t01e9b78b922480d701.jpg\",\"url\":\"http:\\/\\/v.360.cn\\/_0h\\/gqXlZUYnQXP7Tx.html\",\"name\":\"\\u91cd\\u5e86\\u68ee\\u6797\",\"actor\":[\"\\u5f20\\u4e09\",\"\\u674e\\u56db\",\"\\u738b\\u4e94\"],\"year\":\"2011\"},{\"type\":\"11\",\"img\":\"http:\\/\\/p6.qhimg.com\\/t01e9b78b922480d701.jpg\",\"url\":\"http:\\/\\/v.360.cn\\/_0h\\/gqXlZUYnQXP7Tx.html\",\"name\":\"\\u91cd\\u5e86\\u68ee\\u6797\",\"actor\":[\"\\u5f20\\u4e09\",\"\\u674e\\u56db\",\"\\u738b\\u4e94\"],\"year\":\"2011\"},{\"type\":\"12\",\"img\":\"http:\\/\\/p6.qhimg.com\\/t01e9b78b922480d701.jpg\",\"url\":\"http:\\/\\/v.360.cn\\/_0h\\/gqXlZUYnQXP7Tx.html\",\"name\":\"\\u91cd\\u5e86\\u68ee\\u6797\",\"actor\":[\"\\u5f20\\u4e09\",\"\\u674e\\u56db\",\"\\u738b\\u4e94\"],\"year\":\"2011\"},{\"type\":\"11\",\"img\":\"http:\\/\\/p6.qhimg.com\\/t01e9b78b922480d701.jpg\",\"url\":\"http:\\/\\/v.360.cn\\/_0h\\/gqXlZUYnQXP7Tx.html\",\"name\":\"\\u91cd\\u5e86\\u68ee\\u6797\",\"actor\":[\"\\u5f20\\u4e09\",\"\\u674e\\u56db\",\"\\u738b\\u4e94\"],\"year\":\"2011\"},{\"type\":\"11\",\"img\":\"http:\\/\\/p6.qhimg.com\\/t01e9b78b922480d701.jpg\",\"url\":\"http:\\/\\/v.360.cn\\/_0h\\/gqXlZUYnQXP7Tx.html\",\"name\":\"\\u91cd\\u5e86\\u68ee\\u6797\",\"actor\":[\"\\u5f20\\u4e09\",\"\\u674e\\u56db\",\"\\u738b\\u4e94\"],\"year\":\"2011\",\"double\":0.123}]";
    jo = wcpp::json::JSONParser::Load(s);
    H_TEST_ASSERT(jo);
    H_TEST_ASSERT(jo->IsTypeOf(wcpp::json::kJSONArray));
    wcpp::json::JSONArray* ja = wcpp::json::cast<wcpp::json::JSONArray>(jo);
    H_TEST_ASSERT(ja);
...
void parse_json_file(const char* path) {
    ...
    wcpp::uint64 text_parse_time = 0;
    wcpp::uint64 binary_parse_time = 0;
    while (std::getline(fs, line).good()) {
        wcpp::json::JSONObject jo0;
        H_TEST_ASSERT(jo0.Parse(line.data(), line.size()));
        wcpp::uint64 t1begin = wcpp::utcmicrosecond();
        std::string serialize0 = jo0.ToString();
        wcpp::json::JSONObject jo1;
        H_TEST_ASSERT(jo1.Parse(serialize0.data(), serialize0.size()));
        wcpp::uint64 t1end = wcpp::utcmicrosecond();
        ...
        H_TEST_ASSERT(jo1.error() == wcpp::json::JSONParser::kNoError);
        H_TEST_ASSERT(jo2.error() == wcpp::json::JSONParser::kNoError);
        H_TEST_ASSERT(jo3.error() == wcpp::json::JSONParser::kNoError);
        H_TEST_ASSERT(jo4.error() == wcpp::json::JSONParser::kNoError);
        //H_TEST_ASSERT(jo5.error() == wcpp::json::JSONParser::kNoError);
    }
    fs.close();
}
}
...
TEST_UNIT(json_array_complex_test_6) {
    ...
    bool r = false;
    while (std::getline(fs, line).good()) {
        wcpp::json::JSONArray jo0;
        H_TEST_ASSERT(jo0.Parse(line.data(), line.size()));
        std::string serialize0 = jo0.ToString();
        wcpp::json::JSONArray jo1;
        H_TEST_ASSERT(jo1.Parse(serialize0.data(), serialize0.size()));
        std::string serialize1 = jo1.ToString();
        H_TEST_ASSERT(serialize1 == serialize0);
        r = jo1.Equals(jo0);
        H_TEST_ASSERT(r);
        wcpp::json::JSONArray jo2;
        H_TEST_ASSERT(jo2.Parse(serialize1.data(), serialize1.size()));
        std::string serialize2 = jo2.ToString();
        H_TEST_ASSERT(jo2.Equals(jo1));
        H_TEST_ASSERT(jo2.Equals(jo0));
...
void json_error_test_case_1() {
    ...
    H_TEST_ASSERT(jo.error() == wcpp::json::JSONObject::kKeyValueSeperatorError);
...
void json_error_test_case_2() {
    ...
    wcpp::json::JSONObject jo;
    H_TEST_ASSERT(0 == jo.Parse(line.data(), line.size()));
    H_TEST_ASSERT(jo.error() == wcpp::json::JSONObject::kJSONObjectNotBeginWithBraces);
...
void json_error_test_case_3() {
    ...
    wcpp::json::JSONObject jo;
    H_TEST_ASSERT(0 == jo.Parse(line.data(), line.size()));
    H_TEST_ASSERT(jo.error() != wcpp::json::JSONParser::kNoError);
...
TEST_UNIT(json_utf8_punctuation_test) {
    ...
    wcpp::json::JSONArray ja;
    H_TEST_ASSERT(ja.Parse(punctuation.data(), punctuation.size()));
    H_TEST_ASSERT(ja.error() == wcpp::json::JSONParser::kNoError);
    std::string s = ja.ToString();
    wcpp::json::JSONArray ja1;
    H_TEST_ASSERT(ja1.Parse(s.data(), s.size()));
    H_TEST_ASSERT(ja1.error() == wcpp::json::JSONParser::kNoError);
...
std::string encode_unicode_snprintf(wcpp::uint32 codepoint) {
    char seq[13] = {};
...
void encode_unicode(wcpp::uint32 codepoint, wcpp::DataStream& stream) {
    stream.Expand(12);
...
std::string encode_unicode(wcpp::uint32 codepoint) {
    wcpp::DataStream buf;
...
TEST_UNIT(test_json_utf16_encode_unicode) {
    wcpp::uint32 codepoint = 0x10000 - 1;
...
TEST_UNIT(test_json_iterator_compile) {
    wcpp::json::JSONArray ja;
    {
        wcpp::json::JSONArray::iterator it(ja.begin());
        wcpp::json::JSONArray::iterator ite(ja.begin());
        for (; it != ite; ++it) {
            (void)it;
        }
    }
    ...
    wcpp::json::JSONObject jo;
    {
        wcpp::json::JSONObject::Iterator it(jo.begin());
        wcpp::json::JSONObject::Iterator ite(jo.begin());
        for (; it != ite; ++it) {
            (void)it;
        }
    }
...
TEST_UNIT(json_in_json_problem_test) {
    std::string outjson = wcpp::Base64::Decode("");
    wcpp::json::JSONObject joutjson;
    joutjson.Parse(outjson);//1. 第一次JSON解析
    H_TEST_ASSERT(joutjson.ok());

    //2. 取得main_info这个JSONString对象
    wcpp::json::JSONString* jmain_info = joutjson.GetJSONObject("plugin_result")->GetJSONArray("plugins")->GetJSONObject(0)->GetJSONString("main_info");
    H_TEST_ASSERT(jmain_info);

    //3. 取得main_info这个JSONString对象的实际内存的字符串value
    std::string main_info_string = jmain_info->value();
    //    std::cout << "base64(main_info_string)=" << wcpp::Base64::encode(main_info_string) << "\n";

    //4. 最后进行JSON解析
    wcpp::json::JSONObject jmain_info_obj;
...
TEST_UNIT(json_parse_tab_test1) {
    ...
    */
    std::string s = wcpp::Base64::Decode("eyJleHRzIjpbeyJ2YWwiOiJcdTUzOWZcdTk2MzNcdTUzYmZcdTdjYWVcdTk4ZGZcdTVjNDBcdFx1NTM5Zlx1OTYzM1x1NTNiZlx1NTE2Y1x1NTE3MVx1OGQ0NFx1NmU5MFx1NGVhNFx1NjYxM1x1NGUyZFx1NWZjMyIsImtleSI6ImNhbmRpZGF0ZSJ9XX0=");
    wcpp::json::JSONObject jo;
    jo.Parse(s);
    H_TEST_ASSERT(jo.ok());
    wcpp::json::JSONArray* jexts = jo.GetJSONArray("exts");
    H_TEST_ASSERT(jexts);

    wcpp::json::JSONObject* jext = jexts->GetJSONObject(0);
    H_TEST_ASSERT(jext);
    wcpp::json::JSONString* jval = jext->GetJSONString("val");
    H_TEST_ASSERT(jval);

    std::string utf8val = wcpp::Base64::Decode("5Y6f6Ziz5Y6/57Ku6aOf5bGACeWOn+mYs+WOv+WFrOWFsei1hOa6kOS6pOaYk+S4reW/gw==");
    std::string val = jval->value();
    H_TEST_ASSERT(val == utf8val);
    //#ifdef H_OS_WINDOWS
    //    std::string utf8val = wcpp::StringUtil::mbsToUtf8("原阳县粮食局\t原阳县公共资源交易中心");
    //    std::string val = jval->value();
    //    H_TEST_ASSERT(val == utf8val);
    //#else
    //#endif
...
TEST_UNIT(json_parse_tab_test2) {
    std::string escape_strings = wcpp::Base64::Decode("eyAiYSIgOiAiYVx0YlxuY1xiZFxmZVxyIiB9DQ=="); // { "a" : "a\tb\nc\bd\fe\r" }
    wcpp::json::JSONObject jo;
    H_TEST_ASSERT(jo.Parse(escape_strings));
    H_TEST_ASSERT(jo.ok());
    wcpp::json::JSONString* jext = jo.GetJSONString("a");
    H_TEST_ASSERT(jext);
...
TEST_UNIT(json_parse_tab_test3) {
    std::string s = wcpp::Base64::Decode("");
    wcpp::json::JSONObject jo;
    jo.Parse(s);
    H_TEST_ASSERT(jo.ok());
    wcpp::json::JSONString* jval = jo.GetJSONString("main_info");
    H_TEST_ASSERT(jval);
}
...
TEST_UNIT(testJSONDoubleSerialize) {
    ...
    wcpp::json::JSONDouble* d = jo0.GetJSONDouble("cost");
    H_TEST_ASSERT(d);
    std::string s = d->ToString();
    H_TEST_ASSERT(wcpp::StringUtil::Contains(s, ".0"));
}
