...
template<class T, class U>
void JSONArray::GetElement(std::vector<T>& vec, const U& default_value)const {
...
void JSONArray::GetBoolArray(std::vector<bool>& vec, bool default_value)const {
    ...
    GetElement(array, count, default_value);
    std::copy(array, array + count, vec.begin());
    delete[] array;
}

void JSONArray::GetByteArray(std::vector<simcc::uint8>& vec, simcc::uint8 default_value)const {
    GetElement(vec, static_cast<simcc::int64>(default_value));
}

void JSONArray::GetInt32Array(std::vector<simcc::int32>& vec, simcc::int32 default_value)const {
    GetElement(vec, static_cast<simcc::int64>(default_value));
}

void JSONArray::GetInt64Array(std::vector<simcc::int64>& vec, simcc::int64 default_value)const {
    GetElement(vec, static_cast<simcc::int64>(default_value));
}

void JSONArray::GetFloat32Array(std::vector<simcc::float32>& vec, simcc::float32 default_value)const {
    GetElement(vec, static_cast<simcc::float64>(default_value));
}

void JSONArray::GetFloat64Array(std::vector<simcc::float64>& vec, simcc::float64 default_value)const {
    GetElement(vec, static_cast<simcc::float64>(default_value));
}

void JSONArray::GetStringArray(std::vector<string>& vec, const string& default_value)const {
    GetElement(vec, default_value);
}
