...
template<typename TE1, typename TE2 >
inline wcpp::DataStream& operator<< (wcpp::DataStream& file, const Struct2Element<TE1, TE2 >& val) {
...
// Serialize Struct2Element
template<typename TE1, typename TE2 >
inline wcpp::DataStream& operator>> (wcpp::DataStream& file,  Struct2Element<TE1, TE2 >& val) {
    file >> (TE1&)val.v1
         >> (TE2&)val.v2;
...
// Serialize Struct2Element
template<typename TE1, typename TE2, typename TE3 >
inline wcpp::DataStream& operator<< (wcpp::DataStream& file, const Struct3Element<TE1, TE2, TE3 >& val) {
    file << (const TE1&)val.v1
         << (const TE2&)val.v2
         << (const TE3&)val.v3;
    return file;
...
// Serialize Struct2Element
template<typename TE1, typename TE2, typename TE3 >
inline wcpp::DataStream& operator>> (wcpp::DataStream& file,  Struct3Element<TE1, TE2, TE3 >& val) {
    file >> (TE1&)val.v1
         >> (TE2&)val.v2
         >> (TE3&)val.v3;
    return file;
...
template<typename TE1, typename TE2, typename TE3, typename TE4 >
inline wcpp::DataStream& operator<< (wcpp::DataStream& file, const Struct4Element<TE1, TE2, TE3, TE4 >& val) {
    file << (const TE1&)val.v1
         << (const TE2&)val.v2
         << (const TE3&)val.v3
         << (const TE4&)val.v4;
...
template<typename TE1, typename TE2, typename TE3, typename TE4 >
inline wcpp::DataStream& operator>> (wcpp::DataStream& file,  Struct4Element<TE1, TE2, TE3, TE4 >& val) {
    file >> (TE1&)val.v1
         >> (TE2&)val.v2
         >> (TE3&)val.v3
         >> (TE4&)val.v4;
...
inline uint32 DataStream::seekp(int32 offset) {
    ...
    if (nNewPos < 0) {
        ...
        // pre-allocate size.
        if (nNewPos > (wcpp::int64)write_index_) {
...
inline wcpp::uint32 DataStream::GetReadableSize() const {
...
template< typename T>
DataStream& wcpp::DataStream::InternalWriteType(const T& val, std::true_type) {
    Write(&val, sizeof(T));
    return (*this);
}

template< typename T>
DataStream& wcpp::DataStream::InternalReadType(T& val, std::true_type) {
    Read(&val, sizeof(T));
    return (*this);
}

template< typename _Kt >
DataStream& wcpp::DataStream::InternalWriteVector(const std::vector< _Kt >& val, std::true_type) {
    // 1. write length
...
template< typename _Kt >
DataStream& wcpp::DataStream::InternalReadVector(std::vector< _Kt >& val, std::true_type) {
    // check whether the file is bad.
    if (IsReadBad()) {
        return *this;
    }
...
template< typename T>
DataStream& wcpp::DataStream::operator<<(const T& val) {
...
template< typename T>
DataStream& wcpp::DataStream::operator >> (T& val) {
    typedef  typename std::is_pod<T>::type T_type;
    return InternalReadType(val, T_type());
    //return *this;
}

inline wcpp::DataStream& DataStream::operator<<(const std::string& val) {
...
inline wcpp::DataStream& DataStream::operator<<(const char* szVal) {
    if (NULL == szVal) {
        return *this;
    }
...
inline wcpp::DataStream& DataStream::operator >> (std::string& val) {
    // check whether the file is bad.
    if (IsReadBad()) {
        return *this;
    }
...
inline wcpp::DataStream& DataStream::operator<<(const DataStream& val) {
    // 1. write string length
    *this << (uint32)val.size();
...
inline wcpp::DataStream& DataStream::operator >> (DataStream& val) {
    // check whether the file is bad.
    if (IsReadBad()) {
        return *this;
    }
...
DataStream& wcpp::DataStream::operator >> (std::pair<_Kt, _Val>& val) {
...
namespace std {
inline void swap(wcpp::DataStream& l , wcpp::DataStream& r) {
    l.Swap(r);
}
}
