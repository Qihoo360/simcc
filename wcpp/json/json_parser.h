...
public:
    ...
    static ObjectPtr Load(const char* source, const wcpp::int64 source_len = -1);
...
protected:
    ...
    mutable wcpp::DataStream buf_;// The data cache buffer for the sake of improve performance
private:
